...
const RoomCardUI: FC<Room> = (room) =>
    <Card
        ...
        <Row gutter={[16, 16]}>
            ...
            <Col span={12}>
                <Row>
                    <Typography.Text ellipsis>Цена: {convertToMoneyString(room.price)}</Typography.Text>
                </Row>
                <Row>
                    <Typography.Text ellipsis>Тип: {convertToRoomTypesString(room.type)}</Typography.Text>
                </Row>
                <Row>
